...
**Решение 2026-09-06 (ADR `docs/adr/2026-09-06-stt-elevenlabs-scribe-v2.md`):** по смоуку на реальной записи (`bin/stt-bench`, тикет `nikitatrubaev-7cy.1`) владелец выбрал ElevenLabs Scribe v2; рекомендация §4 ниже (Deepgram) отменена.
