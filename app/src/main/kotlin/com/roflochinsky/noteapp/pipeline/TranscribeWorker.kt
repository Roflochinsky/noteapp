...
class TranscribeWorker(context: Context, params: WorkerParameters) :
    ...
    companion object {
        ...
        internal const val NO_KEY = "нет ключа ElevenLabs"
        ...
        /**
         * Причина снимается на любом исходе, кроме известной причины: удача, пустой ответ, обрыв
         * сети, «попробуй позже». Иначе строка «нет ключа ElevenLabs» пережила бы попытку,
         * сделанную уже с ключом, и врала бы владельцу в ленте до самой удачной расшифровки.
         */
